...
This page contains info on some of the virtual buddy applications that I built through the course of my PhD work. Primarily, this includes two major versions of the Virtual Fitness Buddy system and the Virtual STEM Buddy system, which encouraged children to engage in healthier exercise habits and to learn about various STEM concepts respectively. These systems took a <!-- TODO: more specific info on these projects can be found on their individual pages (links). -->
...
<!-- TODO: finish info for VFB-C and VB-F&V from vb-overview-overflow page and paste here -->
