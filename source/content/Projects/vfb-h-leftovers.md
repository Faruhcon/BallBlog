...
<!--- \begin{figure}[!htb]
    \centering\includegraphics[width=0.99\textwidth,height=120mm,keepaspectratio]{figures/Results/Total Weekly Logins C1&C2.png}
    \caption{Graphs showing the number of times participants logged in weekly to the VFB-H system throughout the course of the study separated by cohort. The top graph refers to C1-H weekly logins and the bottom one refers to C2-H weekly logins.}
    \label{fig:vfbh-weekly-logins}
\end{figure}--->
...
<!--- \begin{figure}[!htb]
    \centering\includegraphics[width=0.99\textwidth,height=120mm,keepaspectratio]{figures/Results/combo_participant_gamesPlayed.png}
    \centering\includegraphics[width=0.99\textwidth,height=120mm,keepaspectratio]{figures/Results/combo_participant_timePlayed.png}
    \caption{Graphs depicting the number of plays (top) and amount of time played in seconds (bottom) for each participant for both C1-H and C2-H.}
    \label{fig:vfbh-participant-play-info}
\end{figure}--->

<!--- %TODO: table here on access/unlocks--->
...
<!--- \begin{figure}[!htbp]
    \centering\includegraphics[width=0.99\textwidth,height=120mm,keepaspectratio]{figures/Results/combo_participant_gamesPlayed_perDay.png}
    \centering\includegraphics[width=0.99\textwidth,height=120mm,keepaspectratio]{figures/Results/combo_participant_timePlayed_perDay.png}
    \caption{Graphs depicting the number of plays (top) and amount of time played in seconds (bottom) controlled for days unlocked for each participant for both C1-H and C2-H.}
    \label{fig:vfbh-participant-play-info-per}
\end{figure}--->
...
<!--- \begin{figure}[!htb]
    \centering\includegraphics[width=0.99\textwidth,height=120mm,keepaspectratio]{figures/Results/combo_participant_timePlayed_perDay_conly.png}
    \centering\includegraphics[width=0.99\textwidth,height=120mm,keepaspectratio]{figures/Results/combo_participant_timePlayed_perDay_gonly.png}
    \caption{Graphs depicting the amount of time played in seconds controlled for days unlocked for each child (top) and guardian (bottom) participant for both C1-H and C2-H.}
    \label{fig:vfbh-participant-play-info-per-sep}
\end{figure}--->
...
<!--- 
\begin{figure}[!hb]
    \centering\includegraphics[width=0.99\textwidth,height=120mm,keepaspectratio]{figures/Results/combo_gamesPlayed.png}
    \includegraphics[width=0.99\textwidth,height=100mm,keepaspectratio]{figures/Results/combo_timePlayed.png}
    \caption{Graph depicting the number of plays and amount of time played for each game played for both C1-H and C2-H.}
    \label{fig:vfbh-basic-game-plays}
\end{figure}--->
...
<!--- 
\begin{figure}[!htb]
    \centering\includegraphics[width=0.99\textwidth,height=120mm,keepaspectratio]{figures/Results/combo_gamesPlayed_perDay.png}
    \includegraphics[width=0.99\textwidth,height=120mm,keepaspectratio]{figures/Results/combo_timePlayed_perDay.png}
    \caption{Graph depicting the number of plays and amount of time controlled for number of days unlocked for each game played for both C1-H and C2-H.}
    \label{fig:vfbh-basic-game-plays-perDay}
\end{figure}--->
...
<!--- %As shown in Fig xxx, the play times/counts per week of each game are show and Fig yyy shows the contiguous play time/play count per week--->
...
<!--- \begin{figure}[!htbp]
    \centering\includegraphics[width=0.99\textwidth,height=120mm,keepaspectratio]{figures/Results/outlier50121_timeplayed.png}
    \includegraphics[width=0.99\textwidth,height=120mm,keepaspectratio]{figures/Results/outlier50121_timeplayed_perday.png}
    \caption{Graphs depicting the time played (s) and time played (s) per day for the C1-H game play outlier shown in the top (time played) and bottom (time played per day) graphs.}
    \label{fig:vfbh-outliers-time-somuchtime}
\end{figure}--->
...
<!--- \begin{figure}[!htbp]
    \centering\includegraphics[width=0.99\textwidth,height=120mm,keepaspectratio]{figures/Results/outlier60042_timeplayed.png}
    \includegraphics[width=0.99\textwidth,height=120mm,keepaspectratio]{figures/Results/outlier60042_timeplayed_perday.png}
    \caption{Graphs depicting the time played (s) and time played (s) per day for the C2-H game play outlier shown in the top (time played) and bottom (time played per day) graphs. }
    \label{fig:vfbh-outliers-time-somuchtime-2}
\end{figure}--->
...
<!--- \begin{figure}[!htbp]
    \centering\includegraphics[width=0.99\textwidth,height=120mm,keepaspectratio]{figures/Results/combo_timePlayed_outliersRemoved.png}
    \includegraphics[width=0.99\textwidth,height=120mm,keepaspectratio]{figures/Results/combo_timePlayed_perDay_OutliersRemoved.png}
    \caption{Graphs depicting time played (top) and time played per day (bottom) for all participants, excluding the two individuals with increased gameplay.}
    \label{fig:vfbh-outliers-removed-time-all}
\end{figure}--->
...
<!--- \begin{figure}[!htbp]
    \centering\includegraphics[width=0.99\textwidth,height=100mm,keepaspectratio]{figures/Results/c1-cont-gantt.png}
    \includegraphics[width=0.99\textwidth,height=100mm,keepaspectratio]{figures/Results/c2-cont-gantt.png}
    \caption{Graphs depicting study weeks where a given minigame was played at least once where a contiguous bar represents weeks where a game was played consecutively. The top graph represents C1-H and the bottom represent C2-H.}
    \label{fig:vfbh-mr-gantt}
\end{figure}--->
...
<!--- \begin{figure}[!htbp]
    \centering\includegraphics[width=0.99\textwidth,height=100mm,keepaspectratio]{figures/Results/c1-line-gantt.png}
    \includegraphics[width=0.99\textwidth,height=100mm,keepaspectratio]{figures/Results/c2-line-gantt-sameaxes.png}
    \caption{Graphs depicting minigame plays per week over time for C1-H (top) and C2-H (bottom).}
    \label{fig:vfbh-weekly-plays}
\end{figure}--->
...
<!--- \begin{figure}[!htbp]
    \centering\includegraphics[width=0.99\textwidth,height=94mm,keepaspectratio]{figures/Results/c1-line-gantt-outlier.png}
    \caption{Graph depicting the number of game plays for each game each week for the C1-H game play outlier.}
    \label{fig:plays-line-50121}
\end{figure}--->
...
<!--- \begin{figure}[!htbp]
    \centering\includegraphics[width=0.99\textwidth,height=94mm,keepaspectratio]{figures/Results/c1-line-gantt-outlierremoved.png}
    \caption{Graph depicting the number of game plays for each game each week for C1-H with the game play outlier removed.}
    \label{fig:c1h-line-outlierremoved}
\end{figure}--->
...
<!--- \begin{figure}[!htbp]
    \centering\includegraphics[width=0.99\textwidth,height=94mm,keepaspectratio]{figures/Results/c2-line-gantt-sameaxes-outlier.png}
    \caption{Graph depicting the number of game plays for each game each week for the C2-H game play outlier.}
    \label{fig:plays-line-60042}
\end{figure}--->
...
<!--- \begin{figure}[!htbp]
    \centering\includegraphics[width=0.99\textwidth,height=94mm,keepaspectratio]{figures/Results/c2-line-gantt-sameaxes-outlierremoved.png}
    \caption{Graph depicting the number of game plays for each game each week for C2-H with the gameplay outlier removed.}
    \label{fig:c2h-line-outlierremoved}
\end{figure}--->
...
<!--- \begin{figure}[!htbp]
    \centering\includegraphics[width=0.99\textwidth,height=100mm,keepaspectratio]{figures/Results/c1_lvlup_line.png}
    \includegraphics[width=0.99\textwidth,height=100mm,keepaspectratio]{figures/Results/c2_lvlup_line.png}
    \caption{Graphs depicting VFB level increases over time for C1-H (top) and C2-H (bottom). The red vertical lines represent the earliest start, the V2 minigame update for C1-H or its equivalent for C2-H, and the latest end date for this cohort.}
    \label{fig:vfbh-levelups}
\end{figure}--->
...
<!--- \begin{figure}[!htbp]
    \centering\includegraphics[width=0.99\textwidth,height=100mm,keepaspectratio]{figures/Results/c1h-famrev-line.png}
    \includegraphics[width=0.99\textwidth,height=100mm,keepaspectratio]{figures/Results/c2h-famrev-line.png}
    \caption{Graphs depicting the number of family reviews each week for C1-H (top) and C2-H (bottom).}
    \label{fig:famrev-line}
\end{figure}--->
...
<!--- \begin{figure}[!htbp]
    \centering\includegraphics[width=0.99\textwidth,height=100mm,keepaspectratio]{figures/Results/c1h-famrev-gantt.png}
    \includegraphics[width=0.99\textwidth,height=100mm,keepaspectratio]{figures/Results/c2h-famrev-gantt.png}
    \caption{Graphs depicting the weeks with at least one family review for C1-H (top) and C2-H (bottom). A contiguous bar represents weeks where family reviews were completed during consecutive weeks.}
    \label{fig:famrev-gantt}
\end{figure}--->
...
<!--- \begin{figure}[!htbp]
    \centering\includegraphics[width=0.99\textwidth,keepaspectratio]{figures/Results/heatmap.png}
    \caption{A heatmap visualization of Spearman's correlation between the number of review days and max VFB level, number of level ups, number of plays per day, play time per day, and the number of login days.}
    \label{fig:heatmap}
\end{figure}--->
...
<!--- \begin{figure}[!htbp]
    \centering\includegraphics[width=0.5\textwidth,keepaspectratio]{figures/Results/corr_table.png}
    \caption{Spearman's correlation between the number of review days and max VFB level, number of level ups, number of plays per day, play time per day, and the number of login days for 25 participants.}
...
<!--- \begin{figure}[h]
    \centering\includegraphics[width=0.5\textwidth,height=120mm,keepaspectratio]{figures/Results/c3 move data.png}\includegraphics[width=0.5\textwidth,height=120mm,keepaspectratio]{figures/Results/c3 move data outliers removed.png}
    \caption{Graph depicting the relative use of real world locomotion and virtual joystick locomotion for the VFB-H study, where distance traveled is on the left and percentage of use is on the right (left). The graph on the right side depicts the same data with outliers removed. The units are "Unity 3D units".}
    \label{fig:vfbh-motion}
\end{figure}--->
...
Lastly, while engagement did decrease over time, participants still engaged with the VFB system for a time. This means that we did successfully compete with the aforementioned additional entertainment pressures in the home environment in the short term. Similar to how we learned many lessons through the course of all of our previous public space-based studies, this study is the beginning of learning new lessons with this entirely new environment. Additionally, these two at-home cohorts had vastly fewer participants than their afterschool counterparts, which means lowered engagement from these participants has a much larger impact on our outcomes. Thus, perhaps, what we considered to be game play outliers may actually be more representative of typical engagement outcomes instead of exemplary ones.